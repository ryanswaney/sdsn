...
<form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" data-abide>
  ...
  <input hidden name="retURL" value="http://unsdsn.org/climate-letter/signature-added/">
  ...
  <div class="position">
    <label for="00Nb0000009i2wk">Position</label>
  ...
  <input type="submit" name="submit" class="button small" value="Add Your Support">
