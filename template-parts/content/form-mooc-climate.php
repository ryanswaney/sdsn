...
<form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" data-abide>
  ...
  <input hidden name="retURL" value="http://unsdsn.org/what-we-do/education-initiatives/climate/registration-successful/">
  ...
  <select  hidden id="Campaign_ID" name="Campaign_ID">
    <option value="701b0000000MTel">Climate MOOC</option>
  </select>

  <input type="hidden" name=”member_status” value=”responded”>

  <select  hidden id="lead_source" name="lead_source">
    <option value="Climate MOOC" selected>Climate MOOC</option>
  </select>
